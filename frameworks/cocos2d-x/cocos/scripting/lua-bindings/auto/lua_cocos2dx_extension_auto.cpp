...
int lua_cocos2dx_extension_ScrollView_setTouchEnabled(lua_State* tolua_S)
{
	...
	else if (argc == 2)
	{
		...
		ok &= luaval_to_boolean(tolua_S, 2, &arg0, "cc.ScrollView:setTouchEnabled");
		ok &= luaval_to_boolean(tolua_S, 3, &arg1, "cc.ScrollView:setTouchEnabled");
		if (!ok)
		{
			tolua_error(tolua_S, "invalid arguments in function 'lua_cocos2dx_extension_ScrollView_setTouchEnabled'", nullptr);
			return 0;
		}
		cobj->setTouchEnabled(arg0, arg1);
		lua_settop(tolua_S, 1);
		return 1;
	}
...
int lua_cocos2dx_extension_ScrollView_addChild2Bg(lua_State* tolua_S)
{
    int argc = 0;
    cocos2d::extension::ScrollView* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj)
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_extension_ScrollView_addChild2Bg'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 1)
    {
        ...
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_extension_ScrollView_addChild2Bg'", nullptr);
            return 0;
        }
        cobj->addChild2Bg(arg0);
        lua_settop(tolua_S, 1);
        return 1;
    }
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "cc.ScrollView:addChild2Bg",argc, 1);
    return 0;
    
#if COCOS2D_DEBUG >= 1
tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_extension_ScrollView_addChild2Bg'.",&tolua_err);
#endif
...
int lua_cocos2dx_extension_ScrollView_removeChild2Bg(lua_State* tolua_S)
{
    int argc = 0;
    cocos2d::extension::ScrollView* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj)
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_extension_ScrollView_removeChild2Bg'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 1)
    {
        ...
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_extension_ScrollView_removeChild2Bg'", nullptr);
            return 0;
        }
        cobj->removeChild2Bg(arg0);
        lua_settop(tolua_S, 1);
        return 1;
    }
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "cc.ScrollView:removeChild2Bg",argc, 1);
    return 0;
    
#if COCOS2D_DEBUG >= 1
tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_extension_ScrollView_removeChild2Bg'.",&tolua_err);
#endif
...
int lua_register_cocos2dx_extension_ScrollView(lua_State* tolua_S)
{
    ...
    tolua_beginmodule(tolua_S,"ScrollView");
        ...
        tolua_function(tolua_S,"addChild2Bg",lua_cocos2dx_extension_ScrollView_addChild2Bg);
		tolua_function(tolua_S,"removeChild2Bg",lua_cocos2dx_extension_ScrollView_removeChild2Bg);
    tolua_endmodule(tolua_S);
